...
const Navbar = () => {
    return (
        <div className='max-w-6xl mx-auto w-full rounded-full'>
            <div className='text-white p-6 absolute max-w-6xl w-full mt-4 rounded-full bg-white/10 backdrop-blur-xl flex items-center justify-between' >
                <Link href={"/"}>
                    <Home />
                </Link>
                <div className='flex items-center justify-between gap-4'>
                    <Link
                        ...
                        className="flex flex-row gap-2 items-center  px-2 py-1.5 rounded-md "
                    >
